...
func watchTicker(client *redis.Client) {
	for _, strAssetPair := range fetchAssetsPairs(client) {
		...
		for _, objResult := range response["result"].(map[string]interface{}) {
			...
			client.HSet("Ticker:"+formattedPair+"#"+strconv.Itoa(int(time.Now().Unix())), "AskingPrice", aPrice)
			client.HSet("Ticker:"+formattedPair+"#"+strconv.Itoa(int(time.Now().Unix())), "AskingWholeLotVolume", aWholeLotVolume)
			client.HSet("Ticker:"+formattedPair+"#"+strconv.Itoa(int(time.Now().Unix())), "AskingLotVolume", aLotVolume)

			client.HSet("Ticker:"+formattedPair+"#"+strconv.Itoa(int(time.Now().Unix())), "BidPrice", bPrice)
			client.HSet("Ticker:"+formattedPair+"#"+strconv.Itoa(int(time.Now().Unix())), "BidWholeLotVolume", bWholeLotVolume)
			client.HSet("Ticker:"+formattedPair+"#"+strconv.Itoa(int(time.Now().Unix())), "BidLotVolume", bLotVolume)

			client.HSet("Ticker:"+formattedPair+"#"+strconv.Itoa(int(time.Now().Unix())), "LatestTradePrice", lastTradePrice)
			client.HSet("Ticker:"+formattedPair+"#"+strconv.Itoa(int(time.Now().Unix())), "TwentyFourLotVolume", lastTwentyFourLotVolume)

			client.HSet("Ticker:"+formattedPair+"#"+strconv.Itoa(int(time.Now().Unix())), "TodayTradeVolume", todayTradeVolume)
			client.HSet("Ticker:"+formattedPair+"#"+strconv.Itoa(int(time.Now().Unix())), "TwentyFourTradeVolume", lasttwentyFourTradeVolume)

			client.HSet("Ticker:"+formattedPair+"#"+strconv.Itoa(int(time.Now().Unix())), "TodayWeightedAvgPrice", todayWeightedAvgPrice)
			client.HSet("Ticker:"+formattedPair+"#"+strconv.Itoa(int(time.Now().Unix())), "TwentyFourWeightedAvgPrice", lasttwentyFourWeightedAvgPrice)

			client.HSet("Ticker:"+formattedPair+"#"+strconv.Itoa(int(time.Now().Unix())), "TodayTradeQuantity", todayTradeQuantity)
			client.HSet("Ticker:"+formattedPair+"#"+strconv.Itoa(int(time.Now().Unix())), "TwentyFourTradeQuantity", lastTwentyFourTradeQuantity)

			client.HSet("Ticker:"+formattedPair+"#"+strconv.Itoa(int(time.Now().Unix())), "TodayLow", todayLow)
			client.HSet("Ticker:"+formattedPair+"#"+strconv.Itoa(int(time.Now().Unix())), "TwentyFourLow", lasttwentyFourLow)

			client.HSet("Ticker:"+formattedPair+"#"+strconv.Itoa(int(time.Now().Unix())), "TodayHigh", todayHigh)
			client.HSet("Ticker:"+formattedPair+"#"+strconv.Itoa(int(time.Now().Unix())), "TwentyFourHigh", lasttwentyFourHigh)

			client.HSet("Ticker:"+formattedPair+"#"+strconv.Itoa(int(time.Now().Unix())), "OpeningPrice", todayOpeningPrice)
		}
	}
}
